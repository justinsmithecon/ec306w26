...
format:
  html: default   # keep website version
  pdf:
...
This course introduces the fundamentals of labour market economics,
focusing on how the decisions of workers, firms, and governments shape
employment outcomes. Students will examine how individuals choose
whether and how much to work, how firms determine hiring and wages, and
how policies such as welfare, employment insurance, and taxation
influence those decisions. Core concepts include labour supply and
demand, human capital, gender wage gaps, and the economics of
immigration. The course combines theory with empirical evidence from
Canada and other countries. Students will also build analytical skills
using statistical software and real-world data to evaluate contemporary
...
Benjamin, Dwayne, and Morley Gunderson, and Thomas Lemieux, and Craig
Riddell, and Tammy Schirle. *Labour Market Economics.* 9th edition.
McGraw-Hill Canada, 2021.
...
|:--------------|:-----------------------|:------|
| WLU Bookstore | Physical, Paperback    | \$140 |
| Amazon        | Physical, Paperback    | \$165 |
| McGraw Hill   | Physical, Paperback    | \$140 |
| McGraw Hill   | Online, 180 Day Rental | \$59  |
...
wish, [linked
here](https://chatgpt.com/g/g-685c539cef888191b373a9a5601bcdef-ec306).
...
experience as closely linked to EC306 as possible, I have trained a GPT
...
|:-------------|:-----------------------------------|:-------|
| Assignment 1 | Friday, January 30, 2026 at 9:00pm | 5%     |
| Assignment 2 | Friday, March 27, 2026 at 9:00pm   | 5%     |
| Midterm      | Tuesday, March 3, 2026, in class   | 40%    |
| Final Exam   | TBA                                | 50%    |
...
| Topic | Readings |
|------------------------------------|------------------------------------|
| Introduction to Labour Market Economics | BGLRS Chapter 1 |
| Labour Supply: Individual Attachment to the Labour Market | BGLRS Chapter 2 |
| Labour Supply and Public Policy | BGLRS Chapter 3 |
| Labour Supply Over the Life Cycle | BGLRS Chapter 4 |
| Labour Demand in Competitive Labour Markets | BGLRS Chapter 5 |
| Labour Demand, Nonwage Benefits, and Quasi-fixed Costs | BGLRS Chapter 6 |
| Wages and Employment in a Single Market | BGLRS Chapter 7 |
| Human Capital Theory | BGLRS Chapter 9 |
| Discrimination and Male-Female Earning Differentials | BGLRS Chapter 12 |
| Economics of Immigration | BGLRS Chapter 11 |

## Department Learning Outcomes

The Department of Economics has developed a set of learning goals and
objectives that we expect students to meet by the end of the program.
This course covers the following

| **GOAL** | **OBJECTIVE** |
|------------------------------------|------------------------------------|
| **1. Graduates will have a broad understanding of Economic Theory and Practice.** | 1.1 Identify important economic institutions nationally and globally |
|  | 1.2 Apply appropriate microeconomic models to economic problems. |
|  | 1.4 Demonstrate understanding of empirical techniques in economics. |
| **2. Graduates will have effective communication skills.** | 2.1 Write effectively in a range of different formats. |
| **3. Graduates will have professional skills relevant for careers in economics.** | 3.1 Manage large datasets for the purpose of analysis. |
|  | 3.2 Use computer software common in economic research, including statistical analysis software. |
